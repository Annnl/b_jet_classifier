#This code prints Run2 event yield from each composition
import ROOT
import sys
if len(sys.argv)!= 3:
        print("wrong")
...
numjet_ttbar = ROOT.TH1D("numjet_ttbar","numjet_ttbar",6,2,7)
numjet_ttbar.Sumw2()
numjet_single_top = ROOT.TH1D("numjet_single_top","numjet_single_top",6,2,7)
numjet_single_top.Sumw2()
numjet_V = ROOT.TH1D("numjet_V","numjet_V",6,2,7)
numjet_V.Sumw2()
numjet_H = ROOT.TH1D("numjet_H","numjet_H",6,2,7)
numjet_H.Sumw2()
numjet_diboson = ROOT.TH1D("numjet_diboson","numjet_diboson",6,2,7)
numjet_diboson.Sumw2()
numjet_other = ROOT.TH1D("numjet_other","numjet_other",6,2,7)
numjet_other.Sumw2()
numjet_Z = ROOT.TH1D("numjet_Z","numjet_Z",6,2,7)
numjet_Z.Sumw2()
numjet_data = ROOT.TH1D("numjet_data","numjet_data",6,2,7)
numjet_data.Sumw2()
        
numbjet_ttbar = ROOT.TH1D("numbjet_ttbar","numbjet_ttbar",6,2,7)
numbjet_ttbar.Sumw2()
numbjet_single_top = ROOT.TH1D("numbjet_single_top","numbjet_single_top",6,2,7)
numbjet_single_top.Sumw2()
numbjet_V = ROOT.TH1D("numbjet_V","numbjet_V",6,2,7)
numbjet_V.Sumw2()
numbjet_H = ROOT.TH1D("numbjet_H","numbjet_H",6,2,7)
numbjet_H.Sumw2()
numbjet_diboson = ROOT.TH1D("numbjet_diboson","numbjet_diboson",6,2,7)
numbjet_diboson.Sumw2()
numbjet_other = ROOT.TH1D("numbjet_other","numbjet_other",6,2,7)
numbjet_other.Sumw2()
numbjet_Z = ROOT.TH1D("numbjet_Z","numbjet_Z",6,2,7)
numbjet_Z.Sumw2()
numbjet_data = ROOT.TH1D("numbjet_data","numbjet_data",6,2,7)
numbjet_data.Sumw2()
        
leading_jet_PT_ttbar = ROOT.TH1D("leading_jet_PT_ttbar","leading_jet_PT_ttbar",40,0,1000)
leading_jet_PT_ttbar.Sumw2()
leading_jet_PT_single_top = ROOT.TH1D("leading_jet_PT_single_top","leading_jet_PT_single_top",40,0,1000)
leading_jet_PT_single_top.Sumw2()
leading_jet_PT_V = ROOT.TH1D("leading_jet_PT_V","leading_jet_PT_V",40,0,1000)
leading_jet_PT_V.Sumw2()
leading_jet_PT_H = ROOT.TH1D("leading_jet_PT_H","leading_jet_PT_H",40,0,1000)
leading_jet_PT_H.Sumw2()
leading_jet_PT_diboson = ROOT.TH1D("leading_jet_PT_diboson","leading_jet_PT_diboson",40,0,1000)
leading_jet_PT_diboson.Sumw2()
leading_jet_PT_other = ROOT.TH1D("leading_jet_PT_other","leading_jet_PT_other",40,0,1000)
leading_jet_PT_other.Sumw2()
leading_jet_PT_Z = ROOT.TH1D("leading_jet_PT_Z","leading_jet_PT_Z",40,0,1000)
leading_jet_PT_Z.Sumw2()
leading_jet_PT_data = ROOT.TH1D("leading_jet_data","leading_jet_data",40,0,1000)
leading_jet_PT_data.Sumw2()

leading_bjet_PT_ttbar = ROOT.TH1D("leading_bjet_PT_ttbar","leading_bjet_PT_ttbar",40,0,1000)
leading_bjet_PT_ttbar.Sumw2()
leading_bjet_PT_single_top = ROOT.TH1D("leading_bjet_PT_single_top","leading_bjet_PT_single_top",40,0,1000)
leading_bjet_PT_single_top.Sumw2()
leading_bjet_PT_V = ROOT.TH1D("leading_bjet_PT_V","leading_bjet_PT_V",40,0,1000)
leading_bjet_PT_V.Sumw2()
leading_bjet_PT_H = ROOT.TH1D("leading_bjet_PT_H","leading_bjet_PT_H",40,0,1000)
leading_bjet_PT_H.Sumw2()
leading_bjet_PT_diboson = ROOT.TH1D("leading_bjet_PT_diboson","leading_bjet_PT_diboson",40,0,1000)
leading_bjet_PT_diboson.Sumw2()
leading_bjet_PT_other = ROOT.TH1D("leading_bjet_PT_other","leading_bjet_PT_other",40,0,1000)
leading_bjet_PT_other.Sumw2()
leading_bjet_PT_Z = ROOT.TH1D("leading_bjet_PT_Z","leading_bjet_PT_Z",40,0,1000)
leading_bjet_PT_Z.Sumw2()
leading_bjet_PT_data = ROOT.TH1D("leading_bjet_data","leading_bjet_data",40,0,1000)
leading_bjet_PT_data.Sumw2()

elpt_ttbar = ROOT.TH1D("elpt_ttbar","elpt_ttbar",40,0,1000)
elpt_ttbar.Sumw2()
elpt_top = ROOT.TH1D("elpt_top","elpt_top",40,0,1000)
elpt_top.Sumw2()
elpt_V = ROOT.TH1D("elpt_V","elpt_V",40,0,1000)
elpt_V.Sumw2()
elpt_H = ROOT.TH1D("elpt_H","elpt_H",40,0,1000)
elpt_H.Sumw2()
elpt_diboson = ROOT.TH1D("elpt_diboson","elpt_diboson",40,0,1000)
elpt_diboson.Sumw2()
elpt_other = ROOT.TH1D("elpt_other","elpt_other",40,0,1000)
elpt_other.Sumw2()
elpt_Z = ROOT.TH1D("elpt_Z","elpt_Z",40,0,1000)
elpt_Z.Sumw2()
elpt_data = ROOT.TH1D("elpt_data","elpt_data",40,0,1000)
elpt_data.Sumw2()

mupt_ttbar = ROOT.TH1D("mupt_ttbar","mupt_ttbar",40,0,1000)
mupt_ttbar.Sumw2()
mupt_top = ROOT.TH1D("mupt_top","mupt_top",40,0,1000)
mupt_top.Sumw2()
mupt_V = ROOT.TH1D("mupt_V","mupt_V",40,0,1000)
mupt_V.Sumw2()
mupt_H = ROOT.TH1D("mupt_H","mupt_H",40,0,1000)
mupt_H.Sumw2()
mupt_diboson = ROOT.TH1D("mupt_diboson","mupt_diboson",40,0,1000)
mupt_diboson.Sumw2()
mupt_other = ROOT.TH1D("mupt_other","mupt_other",40,0,1000)
mupt_other.Sumw2()
mupt_Z = ROOT.TH1D("mupt_Z","mupt_Z",40,0,1000)
mupt_Z.Sumw2()
mupt_data = ROOT.TH1D("mupt_data","mupt_data",40,0,1000)
mupt_data.Sumw2()
...
for i in range(len(lines)):
        ...
        for j in range(tree.GetEntries()):
                ...
                for k in range(len(jet_pt)):
                        if btag_77[k] == '\x01' : bjets_PT.append(jet_pt[k])
#                               if int(codecs.encode(btag_77[k],"hex"))== 1 : bjets_n += 1
                if len(bjets_PT) < 2: continue
                if "data" in name:
                        numjet_data.Fill(len(jet_pt))
                        numbjet_data.Fill(len(bjets_PT))
                        leading_bjet_PT_data.Fill(bjets_PT[0]/1000)
                        leading_jet_PT_data.Fill(jet_pt[0]/1000)
                        elpt_data.Fill(el_pt[0]/1000)
                        mupt_data.Fill(mu_pt[0]/1000)
                        if "grp15" in name or "grp16" in name: numdata[0] += 1
                        if "grp17" in name: numdata[1] += 1
                        if "grp18" in name: numdata[2] += 1
                        continue
                w = weight()
                if ID == 410472 or ID in range(411076,411079):
                        numjet_ttbar.Fill(len(jet_pt),w)
                        numbjet_ttbar.Fill(len(bjets_PT),w)
                        leading_bjet_PT_ttbar.Fill(bjets_PT[0]/1000,w)
                        leading_jet_PT_ttbar.Fill(jet_pt[0]/1000,w)
                        elpt_ttbar.Fill(el_pt[0]/1000,w)
                        mupt_ttbar.Fill(mu_pt[0]/1000,w)
                        if "mc16a" in name: wnumttbar[0] += w
                        if "mc16d" in name: wnumttbar[1] += w
                        if "mc16e" in name: wnumttbar[2] += w
                        continue
                if ID == 410648 or ID == 410649 or ID == 410644 or ID == 410645 or ID == 410658 or ID == 410659:        
                        numjet_single_top.Fill(len(jet_pt),w)
                        numbjet_single_top.Fill(len(bjets_PT),w)
                        leading_bjet_PT_single_top.Fill(bjets_PT[0]/1000,w)
                        leading_jet_PT_single_top.Fill(jet_pt[0]/1000,w)
                        elpt_top.Fill(el_pt[0]/1000,w)
                        mupt_top.Fill(mu_pt[0]/1000,w)
                        if "mc16a" in name: wnumtop[0] += w
                        if "mc16d" in name: wnumtop[1] += w
                        if "mc16e" in name: wnumtop[2] += w
                        continue
                if ID in range(410155, 410158) or ID in range(410218, 410221) or ID in range(410276, 410279):
                        numjet_V.Fill(len(jet_pt),w)
                        numbjet_V.Fill(len(bjets_PT),w)
                        leading_bjet_PT_V.Fill(bjets_PT[0]/1000,w)
                        leading_jet_PT_V.Fill(jet_pt[0]/1000,w)
                        elpt_V.Fill(el_pt[0]/1000,w)
                        mupt_V.Fill(mu_pt[0]/1000,w)
                        if "mc16a" in name: wnumV[0] += w
                        if "mc16d" in name: wnumV[1] += w
                        if "mc16e" in name: wnumV[2] += w
                        continue
                if ID == 346345:
                        numjet_H.Fill(len(jet_pt),w)
                        numbjet_H.Fill(len(bjets_PT),w)
                        leading_bjet_PT_H.Fill(bjets_PT[0]/1000,w)
                        leading_jet_PT_H.Fill(jet_pt[0]/1000,w)
                        elpt_H.Fill(el_pt[0]/1000,w)
                        mupt_H.Fill(mu_pt[0]/1000,w)
                        if "mc16a" in name: wnumH[0] += w
                        if "mc16d" in name: wnumH[1] += w
                        if "mc16e" in name: wnumH[2] += w
                        continue
                if ID == 364250 or ID == 364253 or ID == 364254 or ID == 345705 or ID == 345706 or ID == 345723 or ID == 363356 or ID == 363358 or ID in range(364283, 364291) and ID != 364286:
                        numjet_diboson.Fill(len(jet_pt),w)
                        numbjet_diboson.Fill(len(bjets_PT),w)
                        leading_bjet_PT_diboson.Fill(bjets_PT[0]/1000,w)
                        leading_jet_PT_diboson.Fill(jet_pt[0]/1000,w)
                        elpt_diboson.Fill(el_pt[0]/1000,w)
                        mupt_diboson.Fill(mu_pt[0]/1000,w)
                        if "mc16a" in name: wnumdiboson[0] += w
                        if "mc16d" in name: wnumdiboson[1] += w
                        if "mc16e" in name: wnumdiboson[2] += w
                        continue
                if ID == 410560 or ID == 410408 or ID == 346678 or ID == 346676 or ID == 412043:
                        numjet_other.Fill(len(jet_pt),w)
                        numbjet_other.Fill(len(bjets_PT),w)
                        leading_bjet_PT_other.Fill(bjets_PT[0]/1000,w)
                        leading_jet_PT_other.Fill(jet_pt[0]/1000,w)
                        elpt_other.Fill(el_pt[0]/1000,w)
                        mupt_other.Fill(mu_pt[0]/1000,w)
                        if "mc16a" in name: wnumother[0] += w
                        if "mc16d" in name: wnumother[1] += w
                        if "mc16e" in name: wnumother[2] += w
                        continue
                if ID in range(364100,364142):
                        numjet_Z.Fill(len(jet_pt),w)
                        numbjet_Z.Fill(len(bjets_PT),w)
                        leading_bjet_PT_Z.Fill(bjets_PT[0]/1000,w)
                        leading_jet_PT_Z.Fill(jet_pt[0]/1000,w)
                        elpt_Z.Fill(el_pt[0]/1000,w)
                        mupt_Z.Fill(mu_pt[0]/1000,w)
                        if "mc16a" in name: wnumZ[0] += w
                        if "mc16d" in name: wnumZ[1] += w
                        if "mc16e" in name: wnumZ[2] += w
                        continue
        numjet_ttbar.SetDirectory(0)
        numjet_single_top.SetDirectory(0)       
        numjet_V.SetDirectory(0)
        numjet_H.SetDirectory(0)
        numjet_diboson.SetDirectory(0)
        numjet_other.SetDirectory(0)
        numjet_Z.SetDirectory(0)
        numjet_data.SetDirectory(0)
        
        numbjet_ttbar.SetDirectory(0)
        numbjet_single_top.SetDirectory(0)
        numbjet_V.SetDirectory(0)
        numbjet_H.SetDirectory(0)
        numbjet_diboson.SetDirectory(0)
        numbjet_other.SetDirectory(0)
        numbjet_Z.SetDirectory(0)
        numbjet_data.SetDirectory(0)

        leading_bjet_PT_ttbar.SetDirectory(0)
        leading_bjet_PT_single_top.SetDirectory(0)
        leading_bjet_PT_V.SetDirectory(0)
        leading_bjet_PT_H.SetDirectory(0)
        leading_bjet_PT_diboson.SetDirectory(0)
        leading_bjet_PT_other.SetDirectory(0)
        leading_bjet_PT_Z.SetDirectory(0)
        leading_bjet_PT_data.SetDirectory(0)
        
        leading_jet_PT_ttbar.SetDirectory(0)
        leading_jet_PT_single_top.SetDirectory(0)
        leading_jet_PT_V.SetDirectory(0)
        leading_jet_PT_H.SetDirectory(0)
        leading_jet_PT_diboson.SetDirectory(0)
        leading_jet_PT_other.SetDirectory(0)
        leading_jet_PT_Z.SetDirectory(0)
        leading_jet_PT_data.SetDirectory(0)
       
        elpt_ttbar.SetDirectory(0)
        elpt_top.SetDirectory(0)
        elpt_V.SetDirectory(0)
        elpt_H.SetDirectory(0)
        elpt_diboson.SetDirectory(0)
        elpt_other.SetDirectory(0)
        elpt_Z.SetDirectory(0)
        elpt_data.SetDirectory(0)
       
        mupt_ttbar.SetDirectory(0)
        mupt_top.SetDirectory(0)
        mupt_V.SetDirectory(0)
        mupt_H.SetDirectory(0)
        mupt_diboson.SetDirectory(0)
        mupt_other.SetDirectory(0)
        mupt_Z.SetDirectory(0)
        mupt_data.SetDirectory(0)
        
        inFile.Close()
outHistFile = ROOT.TFile.Open(outFileName,"RECREATE")
outHistFile.cd()
numjet_ttbar.Write()
numjet_single_top.Write()
numjet_V.Write()
numjet_H.Write()
numjet_diboson.Write()
numjet_other.Write()
numjet_Z.Write()
numjet_data.Write()

numbjet_ttbar.Write()
numbjet_single_top.Write()
numbjet_V.Write()
numbjet_H.Write()
numbjet_diboson.Write()
numbjet_other.Write()
numbjet_Z.Write()
numbjet_data.Write()

leading_bjet_PT_ttbar.Write()
leading_bjet_PT_single_top.Write()
leading_bjet_PT_V.Write()
leading_bjet_PT_H.Write()
leading_bjet_PT_diboson.Write()
leading_bjet_PT_other.Write()
leading_bjet_PT_Z.Write()
leading_bjet_PT_data.Write()

leading_jet_PT_ttbar.Write()
leading_jet_PT_single_top.Write()
leading_jet_PT_V.Write()
leading_jet_PT_H.Write()
leading_jet_PT_diboson.Write()
leading_jet_PT_other.Write()
leading_jet_PT_Z.Write()
leading_jet_PT_data.Write()
...
totmc = []
for j in range(3):
        totmc.append(wnumttbar[j]+ wnumtop[j]+ wnumV[j] + wnumH[j] + wnumdiboson[j] + wnumother[j]+ wnumZ[j])
print("data 15+16 / 17 / 18:\n",numdata[0],"/",numdata[1],"/",numdata[2],"events")
print("\ntotal MC:\n",round(totmc[0]),"/",round(totmc[1]),"/",round(totmc[2]),"reweighted events")
print("\nttbar:\n",round(wnumttbar[0]),"/",round(wnumttbar[1]),"/",round(wnumttbar[2]),"reweighted events")
print("\nsingle top:\n",round(wnumtop[0]),"/",round(wnumtop[1]),"/",round(wnumtop[2]),"reweighted events")
print("\nV:\n",round(wnumV[0]),"/",round(wnumV[1]),"/",round(wnumV[2]),"reweighted events")
print("\nH:\n",round(wnumH[0]),"/",round(wnumH[1]),"/",round(wnumH[2]),"reweighted events")
print("\ndiboson:\n",round(wnumdiboson[0]),"/",round(wnumdiboson[1]),"/",round(wnumdiboson[2]),"reweighted events")
print("\nother:\n",round(wnumother[0]),"/",round(wnumother[1]),"/",round(wnumother[2]),"reweighted events")
print("\nZ:\n",round(wnumZ[0]),"/",round(wnumZ[1]),"/",round(wnumZ[2]),"reweighted events")
